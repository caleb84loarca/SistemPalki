...
require_once "../model/modif_cliente.php";
#session_start();
                    ...
                    <div class="x_content">
                        ...
                        <form class="" action="../model/clientedatos.php" method="post" novalidate>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" class='optional' name="cliecompania" value="<?php echo $mostrar[5] ?>" data-validate-length-range="5,15" type="text" />
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" class='optional' name="cliedireccion" value="<?php echo $mostrar[6] ?>" data-validate-length-range="5,15" type="text" />
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="email" class='email' name="cliemail" data-validate-linked='email' value="<?php echo $mostrar[7] ?>" required='required'>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control" id="idpais" name="id_pais">
                                        <option value="<?php echo $mostrar[11]; ?>"> Seleccionar de la lista </option>;
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="tel" class='tel' name="tele1" value="<?php echo $mostrar[8] ?>" required='required' />
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="tel" class='tel' name="tele2" value="<?php echo $mostrar[9] ?>" data-validate-length-range="8,20" />
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="tel" class='tel' name="tele3" value="<?php echo $mostrar[10] ?>" data-validate-length-range="8,20" />
                                </div>
                            </div>
